...
<html lang="en">
<head>
<title>APARTADO PARA LABORATORIOS </title>
...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:dir01_comitan@tecnm.mx">dir01_comitan@tecnm.mx </a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i> 9636326270</li>	
					<li class="s-bar">
						<div class="search">
		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"> TEC NM<p class="logo_agile_caption"><h6>CAMPUS COMITAN<h6></p></a></h1>
				</div>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="#rooms" class="menu__link scroll">Laboratorio</a></li>
					...
					<li>
						<div class="w3layouts-banner-top">
							...
							<div class="container">
								...
								<h4>Tecnologico de Comitan</h4>
									<h3>Salones de laboratorio</h3>
										<p>Bienvenido</p>
				...
				<a href="#" class="menu__link" data-toggle="modal" data-target="#myModal">leer más
					...
					<li>
						<div class="w3layouts-banner-top w3layouts-banner-top1">
							<div class="container">
								<div class="agileits-banner-info">
								<h4>Laboratorios de computo</h4>
									<h3>Aparta el salon que mas te convenga</h3>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4><span> Tecnologico Comitan</span></h4>
										<img src="images/imagen1.jpg" alt=" " class="img-responsive">
										<h5></h5>
										<p>El Instituto Tecnológico de Comitán, es una institución pública de educación superior 
										con Sede en Comitán, Chiapas, México.
Actualmente, el Instituto Tecnológico de Comitán imparte 6 carreras a nivel 
licenciatura en áreas de ciencias sociales y administrativas, e ingeniería.
Forma parte del Tecnológico Nacional de México, de la Secretaría de Educación
Pública de México. El instituto fue creado en septiembre de 1992, sustituyendo
al Instituto Tecnológico Agropecuario de Chiapas No. 31, creado en septiembre de 1984.</p>
									</div>
								</div>
							</div>
						</div>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2> SALON DE LABORATORIOS
</h2></a>
</div>
	...
	<div class="banner-bottom">
		<div class="container">	
			<div class="agileits_banner_bottom"><!--
				<h3><span>NUESTRO SISTEMA ES SEGURO</span> bienvenido
</h3>
			</div>
				...
				<ul class="cbp-ig-grid">
					...
					<li>
						<div class="w3_grid_effect">
							...
							<span class="cbp-ig-category">internet
</span>
						</div>
					</li>
				</ul>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">Acerca de el Tecnologico de Comitan
</h3> 
						   <p class="about-para-w3ls">Es una institución pública de educación superior con Sede en Comitán, Chiapas, México. Actualmente, el Instituto Tecnológico de Comitán imparte 6 carreras a nivel licenciatura en áreas de ciencias sociales y administrativas, e ingeniería.
</p>
						   <img src="images/abut.jpg" width="1000" height="600" />
										<div class="w3l-slider-img">
											<img src="images/labred.jpg" width="600" height="400" />
										</div>
                                       <div class="w3ls-info-about">
										    <h4>Dirección</h4>
											<p>Av. Instituto Tecnológico Km. 3.5 Colonia Yocnajab, El Rosario C.P. 30000, Comitán de Domínguez, Chiapas. </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
...
.</p>
			 ...
			 aqui	<div class="advantage-block">
...
<!-- //gallery -->
	 <!-- rooms & rates -->
      <div class="plans-section" id="rooms">
				 <div class="container">
				 <h3 class="title-w3-agileits title-black-wthree">Laboratorios
</h3>
						<div class="priceing-table-main">
				 <div class="col-md-3 price-grid">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/pina.jpg" width="100" height="200" />
							<h4>laboratorio de ingles
</h4>
						</div>
						<div class="price-gd-bottom">
							...
							<br></br>		
								<a href="admin/reservation.php" >	Apartar
</a>
							</div>
						</div>
					</div>
				...
				<div class="col-md-3 price-grid ">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/pina.jpg" width="100" height="200" />
							<h4>laboratorio de redes y comunicaciones digitales</h4>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
									<ul>
				...
				<div class="col-md-3 price-grid lost">
					<div class="price-block agile">
						<div class="price-gd-top">
						<img src="images/pina.jpg" width="100" height="200" />
							<h4>laboratorio de programacion</h4>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
								<ul>
...
<br></br> <br>
				...
				<div class="col-md-3 price-grid wthree lost">
					<div class="price-block agile">
						<div class="price-gd-top ">
						<img src="images/pina.jpg" width="100" height="200" />
							<h4>laboratorio de telecomunicaciones
</h4>
						</div>
						<div class="price-gd-bottom">
							<div class="price-list">
...
:</label>
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Teléfono :</strong>9636326659</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:info@facturacionweb.site">dir01_comitan@tecnm.mx </a></p>
			<p class="contact-agile1"><strong>Direccion :</strong> Av. Instituto Tecnológico Km. 3.5 Colonia Yocnajab, El Rosario C.P. 30000, Comitán de Domínguez, Chiapas.</p>
																
			<div class="social-bnr-agileits footer-icons-agile info">
				<ul class="social-icons3">
								<li><a href="https://www.facebook.com/" class="fa fa-facebook icon-border facebook"> </a></li>
								<li><a href="https://twitter.com/" class="fa fa-twitter icon-border twitter"> </a></li>
			...
			<!--</div>
			<iframe src="https://goo.gl/maps/LRwtLj6wF6TtewH17" ></iframe>
		</div>-->
		<div class="clearfix"></div>
	</div>
</section>
<!-- /contact -->
			<div class="copy">
		        <p> 2022 <a href="index.php">TECNOLOGICO DE COMITAN</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
